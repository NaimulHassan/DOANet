...
# params['channels'] = [0, 1, 2, 3, 4, 5, 6, 7]
...
pretrained_model_path = "../input/static-task-models/best_azi_2367.hdf5"
pretrained_logfile = "../input/static-task-models/trainingLog_2367_azi.csv"
...
model.fit_generator(generator = train_gen, 
                    ...
                    epochs=100, verbose=1, initial_epoch=0,
