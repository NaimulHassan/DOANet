...
pretrained_model_path = "../input/in-flight-task-models/best_azi_0145.hdf5"
pretrained_logfile = "../input/in-flight-task-models/trainingLog_0145_azi.csv"
...
train_filepath = "../input/in-flight-speech-synthetic-data/speech_flight_train_synthetic.hdf5"
...
#%% model path
modelWeightPath = 'best_azi_0145.hdf5'
modelLogPath = 'trainingLog_0145_azi.csv'
...
trainingCallbacks.append(ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=5, verbose=1, min_lr=1e-15, mode='auto', min_delta=1e-4, cooldown=0))
