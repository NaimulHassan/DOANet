...
pretrained_model_path = "../input/static-task-models/best_elev_0145.hdf5"
pretrained_logfile = "../input/static-task-models/trainingLog_0145_elev.csv"
...
#%% model path
modelWeightPath = 'best_elev_0145.hdf5'
modelLogPath = 'trainingLog_0145_elev.csv'

#%% training callbacks
trainingCallbacks = []
trainingCallbacks.append(ModelCheckpoint(filepath=modelWeightPath, monitor='val_loss', verbose=0, save_best_only=True))
# trainingCallbacks.append(EarlyStopping(monitor='val_loss', min_delta=1e-16, patience=25, verbose=0, mode='auto'))
trainingCallbacks.append(ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=5, verbose=1, min_lr=1e-15, mode='auto', min_delta=1e-16, cooldown=0))
